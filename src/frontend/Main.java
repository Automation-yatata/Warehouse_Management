...
public class Main{
    ...
    public LinkedList<LinkedList<String>> searchProduct (DB d, String productName){

        LinkedList<LinkedList<String>> aux = d.queryItemSearchProduct(productName);

        if (aux.isEmpty() == true){
            System.out.print("ERROR: Product Search\n");
            return null;
        }else{
            return aux;
        }
    ...
    public static void main(String[] args){
        ...
        System.out.println(app.searchProduct(database,"Televisao LG"));
